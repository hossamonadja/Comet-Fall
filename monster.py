...
class Monster(animation.AnimateSprite):
    ...
    def damage(self, amount):
        ...
        # verifie l'etat des points de vie
        if self.health <= 0:
          #Reapparaitre commme un nouveau monstre
            self.rect.x = 1000 + random.randint(0, 300)
            ...
            # verifier si la barre d'evenement est charger a son maximum
            if self.game.comet_event.is_full_loaded():
                # retirer le(s) monstre(s) du jeu
    ...
    def forward(self):
        ...
        #si le monstre est en collision
            ...
            #infliger des degats au jouer
            self.game.player.damage(self.attack)

# definir une classe pour la mummy
class Mummy(Monster):
