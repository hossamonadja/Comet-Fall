...
# definir une pour gere l'animation
...
def load_animation_images(sprite_name):
    # charger les 24 images dans ce sprite dans le dossier correspondant
    images = []
...
# definir un dictionaire qui va contenir les images charges de chaque sprite
